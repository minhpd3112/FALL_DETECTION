"""
ProtoGCN Config for Fall Detection - Joint Modality
Based on ntu60_xsub/j.py but adapted for:
...
modality = 'j'  # Joint
graph = 'coco17'  # Custom COCO 17 keypoints
work_dir = f'./work_dirs/fall_detection/j'
